...
# Initiate Flask App
app = Flask(__name__,
           static_folder="static",) # Serve the *static* folder as a static source
...
def verify_true_user(req):
    ...
    if cookie is None or userID is None: # If cookies are not set
        ...
        """
        name, hash, role = db_handler.verify_user(userID) # Verify is a User, and get User ID and passhash
